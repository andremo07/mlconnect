...
public class Teste {
	...
	public static void main(String[] args) throws Exception {
		...
		Venda venda1 = vendaDao.findById("350170798302").get();
//		Venda venda2 = vendaDao.findById("350170446301").get();
//		Venda venda3 = vendaDao.findById("267561977801").get();
//		Venda venda4 = vendaDao.findById("267557009802").get();
//		Venda venda5 = vendaDao.findById("267543910902").get();
